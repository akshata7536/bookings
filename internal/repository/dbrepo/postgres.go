...
// InserRoomRestriction inserts a room restrictions into a database
...
// SearchAvailabilityByDatesByRoomID returns true if there are rooms available for the given dates
...
// SearchAvailabilityForAllRooms returns a slice of all rooms that are available for the given dates
