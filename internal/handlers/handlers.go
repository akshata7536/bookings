...
import (
	...
	"github.com/akshata7536/bookings/internal/forms"
	...
	"github.com/akshata7536/bookings/internal/repository"
	"github.com/akshata7536/bookings/internal/repository/dbrepo"
...
// ReservationSummary handles the reservation summary
...
// ChooseRoom handles the room selection
...
func (m *Repository) BookRoom(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		if errors.Is(err, sql.ErrNoRows) {
			// Log a more informative message and show a user-friendly error
			helpers.ClientError(w, http.StatusNotFound)
			fmt.Fprintf(w, "Room with ID %d not found.", roomID)
			return
		}
		helpers.ServerError(w, err)
		return
